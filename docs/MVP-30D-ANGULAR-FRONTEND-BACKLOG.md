...
| FE-24 | Add minimal issued-invoice adjustment UI after core invoicing works, if API exists. Require reason and show linked adjustment invoice relationship. | API-BILL-01 | No adjustment entry point appears before invoice is issued. |
