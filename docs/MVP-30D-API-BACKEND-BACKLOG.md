...
| API-08 | Produce an API contract note for frontend integration covering auth, invite, password reset, child, guardian, mapping, and attendance endpoints, including the deferred relationship read endpoints for child detail screens. | API-04 to API-07 | `docs/` contains route summary, request/response examples, and known error codes for implemented Week 1 routes. |
