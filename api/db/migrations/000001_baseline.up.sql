...
CREATE TABLE invoices (
    ...
    currency_code character(3) DEFAULT 'GBP'::bpchar NOT NULL,
    ...
    CONSTRAINT invoices_currency_gbp CHECK ((currency_code = 'GBP'::bpchar)),
...
CREATE TABLE payment_attempts (
    ...
    CONSTRAINT chk_payment_attempts_currency_gbp CHECK ((currency_code = 'GBP'::bpchar)),
