...
type Repository interface {
	...
	ListByChildPaginated(ctx context.Context, tenantID, branchID, childID uuid.UUID, limit, offset int) ([]Term, error)
	...
	ListExpiringWithinPaginated(ctx context.Context, tenantID, branchID uuid.UUID, maxTermEndDate time.Time, limit, offset int) ([]Term, error)
	CountExpiringWithin(ctx context.Context, tenantID, branchID uuid.UUID, maxTermEndDate time.Time) (int, error)
