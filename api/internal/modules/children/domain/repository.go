...
type ChildCollectionSettingsRepository interface {
	...
	SetCollectionPassword(ctx context.Context, tx pgx.Tx, tenantID, branchID, childID, id uuid.UUID, password string, updatedAt time.Time, userID, membershipID uuid.UUID) error
}
