...
func (s *stubPrefillRepo) CountRecentInvoiceResendsTx(_ context.Context, _ domain.Tx, _, _, _ uuid.UUID, _ time.Time) (int, error) {
	panic("unused")
}
...
func (s *stubPrefillRepo) DeleteInvoice(_ context.Context, _ domain.Tx, _, _ uuid.UUID, _ uuid.UUID) (int64, error) {
	panic("unused")
}
...
func (s *stubPrefillRepo) UpdateInvoiceLine(_ context.Context, _ domain.Tx, _, _, _ uuid.UUID, _ string, _ int, _, _ domain.Money, _ []byte) (int64, error) {
	panic("unused")
}
