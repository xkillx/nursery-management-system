...
type Repository interface {
	...
	ListInvitesPaginated(ctx context.Context, tenantID, branchID uuid.UUID, status InviteStatus, limit, offset int) ([]Invite, error)
	CountInvites(ctx context.Context, tenantID, branchID uuid.UUID, status InviteStatus) (int, error)
