...
type PaymentRepository interface {
	...
	GetInvoiceForEmailCheckoutForUpdate(ctx context.Context, tx Tx, tenantID, branchID, invoiceID string) (CheckoutInvoiceCandidate, bool, error)
	...
	GetActiveEmailCheckoutForInvoice(ctx context.Context, tenantID, branchID, invoiceID string) (*ActiveCheckoutSession, bool, error)
}
