const PROFILE_SECTION_LABELS: Record<string, string> = {
  ...
  funding_support: 'Benefits and funding support',
...
const PROFILE_MISSING_FIELD_LABELS: Record<string, string> = {
  ...
  benefits_contribute_to_fees_unknown: 'Benefits contribute to fees not answered',
  working_tax_credit_unknown: 'Working tax credit not answered',
  college_uni_paid_to_parent_unknown: 'College/uni paid to parent not answered',
  college_uni_paid_to_nursery_unknown: 'College/uni paid to nursery not answered',
  funding_3yo_term_time_unknown: 'Funding 3yo term time not answered',
  funding_2yo_term_time_unknown: 'Funding 2yo term time not answered',
