...
export class ManagerChildEditStepperComponent implements OnInit, OnDestroy {
  ...
  createParentFromDraft(): void {
    ...
    this.parentsApi.create({
      ...
      address_line1: this.newParentDraft.address_line1.trim() || undefined,
      address_line2: this.newParentDraft.address_line2.trim() || undefined,
      address_city: this.newParentDraft.address_city.trim() || undefined,
      address_postcode: this.newParentDraft.address_postcode.trim() || undefined,
      ...
      next: (parent) => {
        const entry: LinkedParentEntry = {
          ...
          addressCity: parent.address_city || '',
          addressPostcode: parent.address_postcode || '',
          hasParentalResponsibility: parent.has_parental_responsibility ?? this.newParentDraft.has_parental_responsibility,
          canPickUp: parent.can_pick_up ?? this.newParentDraft.can_pick_up,
          isEmergencyContact: parent.is_emergency_contact ?? this.newParentDraft.is_emergency_contact,
          portalStatus: 'none',
          isEditing: true,
          isNew: true,
        };
  ...
  continueFromConsents(): void {
    ...
    this.createChildFromConsents();
  }

  createChildFromConsents(): void {
